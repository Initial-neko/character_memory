...
SETTINGS_SCHEMA: list[dict[str, Any]] = [
    ...
    {
        "id": "space-media",
        "title": "Character Space Media / World",
        "description": "自主上网与多媒体动态。Chance 是测试期能力门控，不是强制发帖概率；能力被放行后角色仍可不用。",
        "fields": [
            {"name": "space_observation_enabled", "label": "Web Observation", "type": "checkbox"},
            {"name": "space_image_search_enabled", "label": "Internet Images", "type": "checkbox"},
            {"name": "space_image_generation_enabled", "label": "AI Images", "type": "checkbox"},
            {"name": "space_voice_post_enabled", "label": "Voice Posts", "type": "checkbox"},
            {"name": "space_link_preview_enabled", "label": "Link Preview", "type": "checkbox"},
            {
                "name": "space_observation_chance",
                "label": "Observation Chance",
                "type": "number",
                "min": 0,
                "max": 1,
                "step": 0.05,
                "help": "每次 Opportunity 是否允许角色考虑上网观察的门控。0=从不，1=每次都允许；允许后角色仍会自行决定是否搜索。",
            },
            {
                "name": "space_media_chance",
                "label": "Image Media Chance",
                "type": "number",
                "min": 0,
                "max": 1,
                "step": 0.05,
                "help": "是否向本轮开放互联网图片/AI 生图。不是强制配图概率。",
            },
            {
                "name": "space_voice_chance",
                "label": "Voice Chance",
                "type": "number",
                "min": 0,
                "max": 1,
                "step": 0.05,
                "help": "是否向本轮开放语音动态。开放后角色仍可只发文字。",
            },
            {
                "name": "space_max_images_per_post",
                "label": "Max Images / Post",
                "type": "number",
                "min": 1,
                "max": 9,
                "step": 1,
                "help": "单条动态最多图片数，产品硬上限始终是 9。",
            },
        ],
    },
    {
