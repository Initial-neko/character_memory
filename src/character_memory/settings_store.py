...
SETTINGS_SCHEMA: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": "测试阶段的角色自主动态参数。保存后重启 Character Runtime 生效；每天仍然只是一次“发或不发”的机会，不是强制发帖。",
        "fields": [
            {"name": "space_autonomy_enabled", "label": "Autonomous Space", "type": "checkbox"},
            {
                "name": "space_daily_window_start_hour",
                "label": "Daily Window Start (hour)",
                "type": "number",
                "min": 0,
                "max": 23,
                "step": 1,
                "help": "角色当天自主动态机会最早出现的本地小时。",
            },
            {
                "name": "space_daily_window_end_hour",
                "label": "Daily Window End (hour)",
                "type": "number",
                "min": 1,
                "max": 24,
                "step": 1,
                "help": "结束小时不包含在窗口内，且必须大于开始小时。",
            },
            {
            ...
            },
            {
                ...
                "max": 3600,
                "step": 10,
                "help": "后台检查到期机会的周期。只影响检查延迟，不增加每天的机会次数。",
            },
        ],
    },
    {
