...
SETTINGS_SCHEMA: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "fields": [
            {"name": "group_autonomy_enabled", "label": "Autonomous Group Chat", "type": "checkbox"},
            {
    ...
    },
    {
        ...
        "description": "随机邂逅的正式调度配置。候选角色在用户明确留下前不占正式角色位；这里保存的是重启后仍生效的正式值，手动测试请使用 Dev Console。",
        "fields": [
            {"name": "encounter_enabled", "label": "Random Encounter", "type": "checkbox"},
            {
