...
"""
    ...
    if event.event_type == EventType.WORLD_OBSERVATION:
        world_contract = """
这是一次已经经过外部网页安全评估后的 World Observation，不是私聊，也不是事实数据库导入。
- 当前 Event.content 只应描述“这次观察对你本人形成的经历/兴趣/反思”，而不是网页摘要。
