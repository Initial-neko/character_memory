...
from character_memory.visual_web import DirectVisualMessageRequest, VisualFrameRequest, normalize_visual_frames
...
def test_visual_frames_are_validated_but_not_written_to_media_storage(tmp_path):
...
def test_visual_capture_assets_cover_camera_display_keyframes_and_call_persistence():
    ...
    assert "function minimizeCall()" in voice
...
def test_dev_console_injects_visual_capture_and_calls_real_vision_path():
    ...
    assert "/static/dev_visual.js" in html
